...
class Webapi_model extends CI_Model {
    ...
    public function getMachineList()
    {
        ...
        if($received_data->action == "getMachine_oven"){
            $lastjobrun = [];
            ...
            $output = array(
                "msg" => "ดึงข้อมูลเครื่อง Oven สำเร็จ",
            ...
            $output = array(
                "msg" => "ดึงข้อมูลเครื่อง Oven ไม่สำเร็จ",
    ...
    {
        $received_data = json_decode(file_get_contents("php://input"));
        if($received_data->action == "loadHistoryList_oven"){
