                        ...
                        <div class="col-md-8">
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <input type="text" name="max_temperature" id="max_temperature" class="form-control" required>
                                </div>
                                <!-- <div class="col-md-12 form-group">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','.temSourceLi' , function(){
            ...
            $('#max_temperature').val(data_master_max_temperature);
                ...
                if(res.data.status == "Select Data Success"){
                    ...
                    for(let i = 0; i < templateSourceData.length; i++){
                        ...
                        <li class="list-group-item temSourceLi"
                            ...
                            data_master_max_temperature="`+templateSourceData[i].master_max_temperature+`"
