                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 form-group">
                            ...
                            <input type="text" name="m_max_temperature" id="m_max_temperature" class="form-control" readonly>
                        </div>
    ...
    <script>
        $(document).ready(function(){
                            ...
                            axios.post(url+'main/searchTemplate' , {
                                ...
                                for(let i = 0; i < templatedataAr.length; i++){
                                    ...
                                    <li class="list-group-item list-group-item list-group-item-action m_selectTemplate"
                                        ...
                                        data_master_max_temperature="`+templatedataAr[i].master_max_temperature+`"
            ...
            $(document).on('change' , '#m_areaid' , function(){
                ...
                $('#frm_savemainData input[name=m_max_temperature]').val('');
            ...
            $(document).on('click' , '.m_selectTemplate' , function(){
                ...
                const data_master_max_temperature = $(this).attr("data_master_max_temperature");
                ...
                $('#m_std_output').val();
                $('#m_max_temperature').val(data_master_max_temperature);
                $('#m_showTemplate').html('');
